def analizar_btts_local_vs_visitante(local_stats, visitante_stats):
    ...
    goles_encajados_local = local_stats.get("goals", {}).get("average", {}).get("against", {}).get("home", 0)
    goles_encajados_visitante = visitante_stats.get("goals", {}).get("average", {}).get("against", {}).get("away", 0)
