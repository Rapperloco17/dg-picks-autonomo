...
def schedule_soccer_analysis():
    schedule.every().day.at("11:00").do(generate_soccer_picks)
    schedule.every().day.at("10:10").do(generar_top5)
    print("⚽ Análisis de fútbol programado a las 11:00 a.m. y Top 5 a las 10:10 a.m. (hora local del servidor)")
