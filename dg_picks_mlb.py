...
# dg_picks_mlb.py – Reactivado con justificación de bateo, forma reciente, Over/Under y nombres de pitchers
...
def main():
    ...
    for game in games:
        home = game['home_team']
        away = game['away_team']
        pitcher_home_name = game['home_pitcher_name']
        pitcher_away_name = game['away_pitcher_name']
